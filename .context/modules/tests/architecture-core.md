# Tests - Architecture (test-helpers.ts)
_SOURCE: Shared test utility exports: makeTestConfig, createTempDirTracker, setupFakeGit_
# Shared test utility exports: makeTestConfig, createTempDirTracker, setupFakeGit
```
...
```
###  Path: `/src/tests/test-helpers.ts`
